...
zpool_feature_init(void)
{
	...
	zfeature_register(SPA_FEATURE_VERSIONED_OBJECTS,
	    "com.delphix:versioned_objects", "versioned_objects",
	    "If using object store, allows object consolidation.",
	    ZFEATURE_FLAG_AGENT, ZFEATURE_TYPE_BOOLEAN, NULL, sfeatures);
