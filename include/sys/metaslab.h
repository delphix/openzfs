...
int metaslab_alloc(spa_t *, metaslab_class_t *, uint64_t,
	...
	int);
int metaslab_alloc_object_multiblock_dva(spa_t *,
    uint64_t, uint64_t, dva_t *);
...
int metaslab_class_allocator_count(metaslab_class_t *);
...
int metaslab_group_allocator_count(metaslab_group_t *);
