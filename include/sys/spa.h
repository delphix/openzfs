...
#define	DVA_GET_BLOCKID(dva)	\
	BF64_GET((dva)->dva_word[1], 0, 63)
#define	DVA_SET_BLOCKID(dva, x)	\
...
extern metaslab_class_t *spa_default_class(spa_t *spa);
extern metaslab_class_t *spa_object_store_class(spa_t *spa);
...
extern void spa_access_block(spa_t *spa, const dva_t *dva);
