...
typedef enum lpc_error {
	...
	LPC_SOCKETFAILURE,	/* socket failure */
	LPC_CONNECT_REFUSED,	/* object agent may not be running */
	LPC_CONNECT_RETRY,	/* retrying connection */
	LPC_CONNECTION_ERROR,	/* error communicating with object agent */
	LPC_UNKNOWN
} lpc_error_t;
